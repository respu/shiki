...
{
  NSTEST_EQUAL( shiki::arity(shiki::make_expr<foo>(42))     , 1u );
  NSTEST_EQUAL( shiki::arity(shiki::make_expr<foo>(6,9))    , 2u );
  NSTEST_EQUAL( shiki::arity(shiki::make_expr<foo>(1,'O',1)), 3u );
  NSTEST_EQUAL( shiki::arity(shiki::make_expr<foo>(1,3,3,7)), 4u );
  NSTEST_EQUAL( shiki::arity(shiki::make_expr<foo>('h','e','l','l','o',' ','c','+','+','!')), 10u );

  NSTEST_TYPE_IS( (shiki::arity_<decltype(shiki::make_expr<foo>(42))>)
                , (std::integral_constant<std::size_t,1u>)
                );
  NSTEST_TYPE_IS( (shiki::arity_<decltype(shiki::make_expr<foo>(6,9))>)
                , (std::integral_constant<std::size_t,2u>)
                );
  NSTEST_TYPE_IS( (shiki::arity_<decltype(shiki::make_expr<foo>(1,'O',1))>)
                , (std::integral_constant<std::size_t,3u>)
                );
  NSTEST_TYPE_IS( (shiki::arity_<decltype(shiki::make_expr<foo>(1,3,3,7))>)
                , (std::integral_constant<std::size_t,4u>)
                );
  NSTEST_TYPE_IS( (shiki::arity_<decltype(shiki::make_expr<foo>('h','e','l','l','o',' ','c','+','+','!'))>)

...
##===================================================================================================
if(NOT SHIKI_COMPILER_OPTIONS_INCLUDED)
  set(SHIKI_COMPILER_OPTIONS_INCLUDED 1)

  if(NOT ${CMAKE_CXX_COMPILER_ID} STREQUAL "MSVC")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++14 -Wall -Wshadow -Wextra")
  endif()
  ...
  if(CMAKE_CXX_FLAGS MATCHES "[^ ]")
    message(STATUS "[shiki] Compilation flags: ${CMAKE_CXX_FLAGS}")
  endif()
